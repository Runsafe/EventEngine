...
public class BossBarLibrary extends Library
{
    ...
    /**
     * Set whether or not players added to this boss bar can see it.
     * Parameter 0: int: Bar ID
    ...
    private static final HashMap<Integer, IBossBar> bossBarList = new HashMap<Integer, IBossBar>();

    private static final HashMap<String, BarColour> barColours = new HashMap<String, BarColour>();
    private static final HashMap<String, BarStyle> barStyles = new HashMap<String, BarStyle>();
    private static final HashMap<String, BarFlag> barFlags = new HashMap<String, BarFlag>();
